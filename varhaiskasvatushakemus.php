...
textarea {
  ...
  <section class="hakemus">
    <div class="paivahoitohakemus">
      <form action="varhaiskasvatushakemussend.php" method="POST">
...
<h1> Varhaiskasvatushakemus </h1> <br>
          ...
          <label for="kosoite">Kotiosoite:</label><br>
          <input type="text" id="kotiosoite" name="kotiosoite" placeholder="Kotiosoite"><br>
